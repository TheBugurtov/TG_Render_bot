...
• <a href="https://www.figma.com/design/a7UeDnUeJGZPx6AGBYpXTa/DS-GRANAT-FAQ?node-id=2041-1289">Отправил запрос через GitLab, а ответ не приходит. Что делать?</a>
...
<b>🧩 Компоненты</b>
• <a href="https://www.figma.com/design/a7UeDnUeJGZPx6AGBYpXTa/DS-GRANAT-FAQ?node-id=2037-1171">Какие компоненты брать из ДС, а какие можно делать локально?</a>
• <a href="https://www.figma.com/design/a7UeDnUeJGZPx6AGBYpXTa/DS-GRANAT-FAQ?node-id=33-184">Что можно менять в компонентах?</a>
• <a href="https://www.figma.com/design/a7UeDnUeJGZPx6AGBYpXTa/DS-GRANAT-FAQ?node-id=71-603">Что делать, если в спецификации нет ответа?</a>
• <a href="https://www.figma.com/design/a7UeDnUeJGZPx6AGBYpXTa/DS-GRANAT-FAQ?node-id=2041-1344">Как давать обратную связь по библиотекам?</a>

<b>🎨 Иконки</b>
• <a href="https://www.figma.com/design/a7UeDnUeJGZPx6AGBYpXTa/DS-GRANAT-FAQ?node-id=42-115">Почему нельзя копировать иконки?</a>
• <a href="https://www.figma.com/design/a7UeDnUeJGZPx6AGBYpXTa/DS-GRANAT-FAQ?node-id=42-165">Что делать, если нет нужной иконки?</a>

<b>🎛️ Токены и темы</b>
• <a href="https://www.figma.com/design/a7UeDnUeJGZPx6AGBYpXTa/DS-GRANAT-FAQ?node-id=2041-1322">Как правильно работать с токенами?</a>
• <a href="https://www.figma.com/design/a7UeDnUeJGZPx6AGBYpXTa/DS-GRANAT-FAQ?node-id=2041-1330">Зачем токены с прозрачностью?</a>
